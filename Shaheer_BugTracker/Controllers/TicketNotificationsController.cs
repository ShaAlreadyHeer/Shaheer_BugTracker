...
namespace Shaheer_BugTracker.Controllers
{
    ...
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,NotificationBody,CreatedDate,RecipientId,IsRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,NotificationBody,CreatedDate,RecipientId,IsRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
