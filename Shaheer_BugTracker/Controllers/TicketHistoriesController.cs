...
namespace Shaheer_BugTracker.Controllers
{
    ...
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,Changed,UpdaterId,UpdateDate")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,Changed,UpdaterId,UpdateDate")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
